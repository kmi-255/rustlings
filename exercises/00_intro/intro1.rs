...
fn main() {
    ...
    println!("up, and then run `rustlings lsp` before continuing."); // Michaël : ajout d'un point-virgule manquant pour cette instruction. Il s'agit de la syntaxe propre à Rust.  
}
