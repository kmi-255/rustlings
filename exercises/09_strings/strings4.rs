...
fn main() {
    string_slice("blue"); //Michaël : la fonction string_slice nécessite de destructurer "&str"
    string("red".to_string()); // Michaël : la fonction string ne prend qu'une chaine de caractère en argument
